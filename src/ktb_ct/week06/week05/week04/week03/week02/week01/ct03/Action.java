package ktb_ct.week06.week05.week04.week03.week02.week01.ct03;
...
public class Action {
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); // 입력을 효율적으로 처리하기 위해 BufferedReader 사용
    ...
    public static boolean bfs(int x, int y) {
        ...
        while (!queue.isEmpty()) { // 큐가 비어있지 않은 동안 반복
            ...
            for (int i = 0; i < 4; i++) { // 네 방향으로 이동
                ...
                if (nx >= 0 && nx < M && ny >= 0 && ny < N && grid[nx][ny] == 0 && !visited[nx][ny]) { // 다음 좌표가 유효한 범위 내에 있고 흰색 격자이며 방문하지 않은 경우
